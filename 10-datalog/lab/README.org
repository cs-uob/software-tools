...
- You can read a file if you are its owner.
...
- Make sure that a principal who has been delegated to can also redelegate the decision to someone else!

** Role-based access control

- Add roles to your access control system.  For example, a principal may be happy to say that an auditor can read their files, but may not know who the auditors currently are.
