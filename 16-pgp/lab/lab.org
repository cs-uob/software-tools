...
For the examples in this lab I'm going to be emailing François Dupressoir (head of the Cryptography group) a lot.  Replace him and me with a friend and yourself as appropriate.
...
:       364B7926504D564513777801413109AF27CBFBF9
: uid           [ultimate] Jo Hallett (jh18636) <joseph.hallett@bristol.ac.uk>
: uid           [ultimate] Jo Hallett (Gretchin) <josephhallett@gmail.com>
: uid           [ultimate] Jo Hallett (Gretchin) <bogwonch@bogwonch.net>
: uid           [ultimate] [jpeg image of size 3876]
: ssb   rsa3072 2023-04-25 [E]
...
#+begin_src sh
  ...
  [ultimate] (1). Jo Hallett <bogwonch@bogwonch.net>
...
There are other "fun" options[fn:2] in the =--edit-key= interface!  Type =help= to see commands... =addphoto= looks interesting...
...
Or you can search for them on a keyserver.  My key is number 1.  You can import it if you like.
...
#+RESULTS:
#+begin_src sh
(1)	Jo Hallett (jh18636) <joseph.hallett@bristol.ac.uk>
	Jo Hallett (jh18636) <josephhallett@bristol.ac.uk>
	Jo Hallett (Gretchin) <josephhallett@gmail.com>
	Jo Hallett (Gretchin) <bogwonch@bogwonch.net>
	Joseph Hallett <bogwonch@bogwonch.net>
...
key "Jo Hallett <bogwonch@bogwonch.net>" (413109AF27CBFBF9)
...
gpg: Good signature from "Jo Hallett <bogwonch@bogwonch.net>" [ultimate]
gpg:                 aka "Jo Hallett <joseph.hallett@bristol.ac.uk>" [ultimate]
